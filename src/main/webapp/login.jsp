                    ...
                    <div class="mdl-card mdl-shadow--2dp" style="padding:20px;">
                        <form action="<c:url value="/Controller" />" method="POST">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                ...
                                <label class="mdl-textfield__label" for="login"><fmt:message key="login.login" /></label>
                            </div>
                            <br>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input type="password" name="password" class="mdl-textfield__input" id="password" required/>
                                <label class="mdl-textfield__label" for="password"><fmt:message key="login.password" /></label>
                            </div>
                            <input type="hidden" name="command" value="login" />
                            <br>
                            <input name="submit" type="submit" value="<fmt:message key="login.button" />" class="btn mdl-button mdl-js-button mdl-button--raised mdl-button--accent mdl-js-ripple-effect" />
                        </form>
                    </div>
                </center>
            </main>
